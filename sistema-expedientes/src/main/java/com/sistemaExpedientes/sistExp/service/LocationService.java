...
public class LocationService {
    ...
    public LocationResponseDto update(LocationRequestDto locationRequestDto) {
        try {
            Location existingLocation = verifyLocation(locationRequestDto.getId());
    ...
    public void delete(String id) {
        Location location = verifyExpedient(Long.parseLong(id));
    ...
    private Location verifyExpedient(Long id) {
